...
namespace Mutagen.Bethesda.FormKeys.SkyrimSE
{
    public static partial class SailorMoonClub
    {
        public static class VisualEffect
        {
            ...
            public static FormLink<IVisualEffectGetter> AbsorbMoonTargetVFX01 => Construct(0x844);
            public static FormLink<IVisualEffectGetter> AbsorbMoonCastVFX01 => Construct(0x845);
        }
    }
}
